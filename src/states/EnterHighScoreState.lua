...
-- individual chars of the string stored in ASCII
local chars = {
    [1] = 65,
    [2] = 65,
    [3] = 65,
...
function EnterHighScoreState:update(dt)
    if love.keyboard.wasPressed('enter') or love.keyboard.wasPressed('return') then
        ...
        -- go backwards through high scores table till this score index, shifting scores by 1
