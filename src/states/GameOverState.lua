...
function GameOverState:update(dt)
    if love.keyboard.wasPressed('enter') or love.keyboard.wasPressed('return') then
        ...
        -- keep track of what high score the new one overwrites, if any
...
function GameOverState:render()
    ...
    love.graphics.printf('Final Score: ' .. tostring(self.score), 0, VIRTUAL_HEIGHT - VIRTUAL_HEIGHT / 3, VIRTUAL_WIDTH, 'center')
